...
const Reference = () => {
  return (
    <div className="w-full">
      ...
      <div className="flex justify-center bg-gradient-to-r from-[#B52224] to-[#600018] ~gap-3/6 ~py-2/[2.75rem]">
        <img
          className="size-full max-w-[18rem] object-cover"
          src={Ref5Img}
          alt=""
        />
        <img
      ...
      <div className="flex w-full items-center justify-center ~gap-4/8 ~py-4/8">
        <span className="font-bold uppercase text-primary ~text-[0.75rem]/[1.25rem] ~leading-[1.125rem]/[2.25rem]">
          Hosted on
        </span>
